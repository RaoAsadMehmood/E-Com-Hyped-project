      ...
      <div className='overflow-x-hidden'>
          ...
          <div className="max-w-6xl w-full flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-12">
            ...
            >
              ...
              <p className="mt-4 text-[#cdd8dd] font-medium text-left text-[16px] sm:text-[18px] md:text-[20px] lg:text-[22px] leading-relaxed max-w-full ">
                Are you looking to invest in a profitable opportunity that can help you maximize your returns in just 12 months? Look no further than FBA Automation by Ecom Hyped! Our automated Amazon store solutions are designed to help investors like you achieve maximum profitability with minimum effort. With our expert team of Amazon FBA partners, we can help you launch and manage a successful Amazon store that generates consistent revenue month after month.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <section className="w-full px-4 py-12 mt-[80px]  sm:px-8 md:px-[60px] lg:px-[120px] mb-6">
          ...
          >
            ...
            <motion.div
              className="lg:col-span-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-20 "
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
            >
              {[ // wrap cards in map to reuse animation
                ...
                },
                {
                  ...
                  heading: "CAnnual Returns of Investment",
                  description: "40% - 60% ",
                },
              ].map((card, index) => (
                <motion.div
        ...
        <section className="mb-[50] px-4 sm:px-8 md:px-[60px] lg:px-[120px] flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-[#45565F] text-[16px] sm:text-[17px] md:text-[18px] mb-6 text-center lg:text-left">
              Our team of Amazon FBA experts will work with you to identify the best products to sell on Amazon, source them from trusted
              suppliers, and launch them on your Amazon store. We will then use our advanced marketing and optimization strategies to
              increase your stores visibility and sales, ensuring consistent revenue month after month. Our real-time reporting, analytics,
              and risk monitoring tools will give you complete transparency into your investment, allowing you to make informed decisions
              about your Amazon store.
            </p>
            <motion.div
        ...
        <div className="flex flex-col-reverse lg:flex-row justify-between items-center gap-[16px] px-4 py-16 max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-[#334047] text-[28px] sm:text-[32px] md:text-[38px] lg:text-[44px] font-semibold leading-snug mb-6">
              Stories of Investors Who Maximized Profits with Our FBA Automation Services
            </p>

            <p className="text-[#45565F] text-[18px] font-medium sm:text-[17px] md:text-[18px] leading-relaxed mb-6">
              At EcomHyped, we believe in transparency and reliability, and thats why we are proud to share our triumph tales with you.
              Our success stories highlight real investors who trusted us to help them maximize profits with FBA automation.
              We provide real-time reporting, analytics, and risk monitoring to ensure the success of our clients. With our gold and elite
              packages, we partner with you to establish an Amazon FBA store and work tirelessly to make sure your store generates
              a monthly ROI of 15% to 18%. Our goal is to help you achieve financial success and we are dedicated to being a trusted partner
              in your journey.
            </p>
        ...
        <div className='my-[80px]'>
          ...
          <StatsHeroSection heading={"Let's Connect - Get in Touch Ecom Hyped!"}
            description={"At EcomHyped, we are always happy to connect with new and potential clients. If you're interested in learning more about our services or how we can help you succeed in the world of e-commerce, we encourage you to get in touch. You can contact us by phone, email, or through our website, and we'll be happy to answer any questions you may have. Let's connect and start working together to achieve your e-commerce goals."} />
        </div>
        {/* Companies Logo  */}
