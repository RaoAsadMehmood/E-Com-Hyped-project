    ...
    const navLinks = [
        { name: 'Home', href: '/home' },
        {
            ...
            subLinks: [
                ...
                { name: 'Product Research/Sourcing', href: '/servicespage/product-research' },
                { name: 'Seller Central Management', href: '/servicespage/automation' },
                { name: 'Brand Management', href: '/servicespage/automation' },
                { name: 'Amazon Listing Optimization', href: '/servicespage/automation' },
                { name: 'PPC Optimization', href: '/servicespage/automation' },
            ],
        },
