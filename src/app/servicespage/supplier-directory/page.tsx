  ...
  return (
    <>
      ...
      <div className="overflow-x-hidden">
          ...
          <div className="max-w-6xl w-full flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-12">
            ...
            >
              ...
              <p className="mt-4 text-[#cdd8dd] font-medium text-left text-[16px] sm:text-[18px] md:text-[20px] lg:text-[22px] leading-relaxed max-w-full ">
                Struggling to find reliable suppliers for your Amazon store? Our
                curated Supplier Directory connects you with verified,
                trustworthy manufacturers and wholesalers across the globe.
                Whether you are launching a new product or scaling your existing
                store, our directory saves you hours of research and helps you
                source quality products faster, safer, and smarter.
              </p>
        ...
        <div className="my-[80px] px-4 sm:px-6 md:px-10 lg:px-[120px]">
          ...
          >
            ...
            <p className="text-[#45565F] text-[15px] sm:text-[16px] md:text-[17px] lg:text-[18px] leading-relaxed max-w-full lg:max-w-[700px] text-left">
              Our Supplier Directory service offers a curated list of trusted
              and verified suppliers to help you source high-quality products
              with confidence. From finding the right manufacturer to ensuring
              reliable communication, we simplify the sourcing process—saving
              you time, reducing risks, and helping you scale your Amazon
              business faster.
            </p>
          </motion.div>
        </div>
        ...
        <section className="my-[80px] mx-[40px] px-4 sm:px-8 md:px-[60px] lg:px-[120px] flex flex-col-reverse lg:flex-row items-center justify-between gap-8">
          {/* Left Text Content */}
          <motion.div
          ...
          >
            ...
            <p className="text-[#45565F] text-[16px] sm:text-[17px] md:text-[18px] leading-relaxed mb-6">
              Stop wasting time on unreliable suppliers. Our curated Supplier
              Directory connects you directly with vetted, high-quality
              manufacturers and wholesalers worldwide. Whether you’re launching
              your first product or scaling an existing brand, we help simplify
              your sourcing journey—giving you more confidence, better margins,
              and faster growth.
            </p>
            <ul className="list-disc list-inside text-[#45565F] text-[16px] sm:text-[17px] md:text-[18px] space-y-2 mb-6">
              <li>
                Access a hand-picked network of reliable and verified suppliers
              </li>
              <li>
                Eliminate risks of scams, low-quality goods, and delayed
                shipments
              </li>
              <li>
                Save time with ready-to-contact supplier info and sourcing
                support
              </li>
        ...
        `,
          ...
          >
            ...
            <p className="text-[#45565F] text-[16px] sm:text-[17px] md:text-[18px] leading-relaxed mb-6">
              Our supplier directory connects you with pre-vetted, reliable
              manufacturers and wholesalers worldwide. From sourcing quality
              products to building trustworthy partnerships, our platform
              empowers you to find the right suppliers and grow your business
              with confidence.
            </p>

            <ul className=" text-[#45565F] text-[16px] sm:text-[17px] md:text-[18px] space-y-2 mb-6">
              <li>
                <b>Vetted Suppliers:</b> Gain instant access to a network of
                trusted and verified global suppliers.
              </li>
              <li>
                <b>Easy Sourcing:</b> Find the right supplier based on category,
                region, or MOQs in just a few clicks.
              </li>
              <li>
                <b>Transparent Info:</b> View clear supplier profiles with
                contact details, ratings, and business history.
              </li>
              <li>
                <b>Fast Connections:</b> Streamline your sourcing process and
                save weeks of supplier research.
              </li>
            </ul>
          </motion.div>
        </div>
        ...
        <div className="my-[80px]">
          <StatsHeroSection
            heading={
              "Streamline Your Product Sourcing with Our Expert Supplier Directory"
            }
            description={
