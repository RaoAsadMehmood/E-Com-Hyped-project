"use client";
import  { useState, useRef, useCallback } from "react"; // Make sure these are imported in your About.tsx
...
const About = () => {
  return (
    ...
    {/* Video Testimonials Display - Now stacked vertically */}
    <div className="flex flex-col gap-8 md:gap-12"> {/* Changed from grid to flex-col for vertical stacking */}
        {/* Video 1 */}
        {(() => { // Using an IIFE to scope state for each video
            ...
            return (
                <motion.div
                    ...
                    viewport={{ once: true, amount: 0.3 }}
                    className="relative w-full h-[350px] sm:h-[450px] md:h-[550px] lg:h-[600px] rounded-[20px] p-[5px] bg-transparent overflow-hidden cursor-pointer" // Increased height
                    style={{
                        background: "linear-gradient(to right, rgba(2, 111, 114, 0.75), rgba(247, 165, 30, 0.55))",
                    }}
                    onClick={togglePlay} // Click anywhere on the container to play/pause
                >
                    <div className="w-full h-full rounded-[15px] overflow-hidden bg-black relative">
                        <video
                            ...
                            playsInline
                            preload="auto"
                            // removed controls to allow custom play/pause to work exclusively
                            className="w-full h-full object-cover"
                        >
                            Your browser does not support the video tag.
                        </video>
                        ...
                        {!isPlaying && (
                            <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 transition-opacity duration-300">
                                <svg
                                    className="w-20 h-20 text-[#F7A51E]" // Increased size and set color
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
        ...
        {(() => {
            ...
            return (
                <motion.div
                    initial={{ opacity: 0, y: 50 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8, ease: "easeOut", delay: 0.3 }} // Staggered delay
                    viewport={{ once: true, amount: 0.3 }}
                    className="relative w-full h-[350px] sm:h-[450px] md:h-[550px] lg:h-[600px] rounded-[20px] p-[5px] bg-transparent overflow-hidden cursor-pointer" // Increased height
                    style={{
                        background: "linear-gradient(to left, rgba(2, 111, 114, 0.75), rgba(247, 165, 30, 0.55))", // Different gradient
                    }}
                    onClick={togglePlay}
                >
                    <div className="w-full h-full rounded-[15px] overflow-hidden bg-black relative">
        ...
        {(() => {
            ...
            return (
                <motion.div
                    ...
                    className="relative w-full h-[350px] sm:h-[450px] md:h-[550px] lg:h-[600px] rounded-[20px] p-[5px] bg-transparent overflow-hidden cursor-pointer" // Increased height
                    style={{
                        background: "linear-gradient(to right, rgba(247, 165, 30, 0.55), rgba(2, 111, 114, 0.75))", // Another gradient for variety
                    }}
                    onClick={togglePlay}
                >
                    <div className="w-full h-full rounded-[15px] overflow-hidden bg-black relative">
