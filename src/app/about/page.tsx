    ...
    <>
      <div className=' overflow-x-hidden'>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {[
              ...
              >
                ...
                <Image src={item.icon} alt={item.title} width={74} height={74} />
        ...
        <div className='my-[80px]'>
          ...
          <StatsHeroSection heading={'Collaborating for Success'}
            description={'At EcomHyped, we believe that collaboration is key to success. We partner with a range of companies and organizations to provide our clients with the best possible solutions and support. Our partners include e-commerce platforms, product manufacturers and marketing agencies.'} />
        </div>
        ...
        <div className="flex flex-col-reverse lg:flex-row justify-between items-center gap-[16px] px-4 py-16 max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-[#45565F] text-[18px] font-medium sm:text-[17px] md:text-[18px] leading-relaxed mb-6">
              At EcomHyped, we measure our success by the success of our clients. We have helped numerous e-commerce businesses
              achieve their goals and maximize their profits, and we are proud to share their success stories with you.
              From new sellers launching their first products to established businesses expanding their reach and profitability,
              we have helped a wide range of clients achieve their dreams.
            </p>
        ...
        <div className="flex flex-col-reverse lg:flex-row justify-between items-center gap-[16px] px-4 py-16 max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-[#334047] text-[28px] sm:text-[32px] md:text-[38px] lg:text-[44px] font-semibold leading-snug mb-6">
              Dedicated to Your Success - Our Commitment          </p>

            <p className="text-[#45565F] text-[18px] font-medium sm:text-[17px] md:text-[18px] leading-relaxed mb-6">
              At EcomHyped, we are committed to helping our clients succeed. We understand that the world of e-commerce can be complex
              and challenging, and we are here to help our clients navigate this landscape with confidence and ease. We are dedicated
              to providing the best possible service and support, and we are always looking for ways to improve and innovate.
              We believe in building long-term relationships with our clients, and we are committed to their success, no matter what
              it takes.
            </p>
          ...
          >
            <div className="max-w-4xl mx-auto flex flex-col items-center gap-4">
              ...
              <motion.p
                ...
                viewport={{ once: true }}
              >
                At EcomHyped, we are always happy to connect with new and potential clients. If you are interested in learning
                more about our services or how we can help you succeed in the world of e-commerce, we encourage you to get in touch.
                You can contact us by phone, email, or through our website, and we will be happy to answer any questions you may have.
                Lets connect and start working together to achieve your e-commerce goals.
              </motion.p>
